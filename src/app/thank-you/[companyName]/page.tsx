    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 flex items-center justify-center p-2 sm:p-4">
      <div className="max-w-3xl w-full">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-lg sm:text-xl lg:text-3xl font-bold text-slate-800 mb-4">
            Thank You for Completing the Audit
          </h1>
          
          {company?.name && (
            <p className="text-sm sm:text-base lg:text-xl text-slate-600 mb-6">
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-slate-200/60 overflow-hidden">
          <div className="p-4 sm:p-6 lg:p-8">
            <div className="space-y-4 sm:space-y-6 text-slate-700">
              ...
              {/* Key Features List */}
              <div className="bg-slate-50 rounded-xl p-3 sm:p-4 lg:p-6 border border-slate-200">
                <ul className="space-y-3 sm:space-y-4">
                  <li className="flex items-start space-x-4">
                    ...
                    <span className="text-xs lg:text-base leading-relaxed">Your business readiness score</span>
                  </li>
                  ...
                  <li className="flex items-start space-x-4">
                    ...
                    <span className="text-xs lg:text-base leading-relaxed">Key gaps and opportunities identified</span>
                  </li>
                  ...
                  <li className="flex items-start space-x-4">
                    ...
                    <span className="text-xs lg:text-base leading-relaxed">Practical next steps to help you achieve your goals</span>
                  </li>
                </ul>
              </div>
          ...
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border-t border-slate-200 p-4 sm:p-6 lg:p-8">
            <div className="text-center">
              ...
              <h3 className="text-sm sm:text-base lg:text-xl font-semibold text-slate-800 mb-2">
                Watch Your Inbox
              </h3>
