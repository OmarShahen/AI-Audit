// Client-Facing Report Generation Instructions
// This contains the comprehensive prompt for generating professional client-facing audit reports
...
export const getClientReportPrompt = (clientReportData: ClientPrompt) => {
  return `
You are a senior business consultant AI tasked with analyzing a completed AI & Automation Readiness Audit and generating a professional CLIENT-FACING REPORT.
...
REPORT HEADER
${clientReportData.industry} Technology & Workflow Opportunity Report
Prepared for: ${clientReportData.name}
Date: ${clientReportData.currentDate}
