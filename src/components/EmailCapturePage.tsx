              ...
              <img
                ...
                onError={(e) => {
                  e.currentTarget.src =
                    ...
                    encodeURIComponent((companyName || "C").charAt(0));
                }}
              />
            </div>
          ) : (
          ...
          <div className="p-8">
            <div className="text-center mb-6">
              ...
              <p className="text-slate-600 leading-relaxed">
                Thank you for completing the assessment! Enter your email
                address to receive your personalized AI & Automation readiness
            ...
            <div className="space-y-3 mb-8">
              <div className="flex items-start space-x-3">
                ...
                <p className="text-sm text-slate-600">
                  ...
                  Custom analysis based on your specific business needs
                </p>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <p className="text-sm text-slate-600">
                  <span className="font-medium">Quick & Easy</span> - Takes only
            ...
            <p className="text-xs text-slate-500 text-center mt-4 leading-relaxed">
              ...
              personalized report. No spam, ever.
            </p>
          </div>
        </div>
